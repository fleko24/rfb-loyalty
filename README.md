[![CircleCI](https://circleci.com/gh/fleko24/rfb-loyalty.svg?style=svg)](https://circleci.com/gh/fleko24/rfb-loyalty)
...
To optimize the rfbloyalty application for production, run:
